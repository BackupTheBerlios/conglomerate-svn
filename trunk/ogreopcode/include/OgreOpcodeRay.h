...
namespace OgreOpcode
{
	namespace Details
    {
		...
		public:
			...
			/// Setups this ray
			void set( Real ox, Real oy, Real oz,
			...
			/// Setups this ray
			void set( const Vector3& ori, const Vector3& dir )
			{
				origin = ori;
				direction = dir;
				direction.normalise();
			 ...
			 */
			void setDirection( Real x, Real y, Real z, bool normalize = true )
			{ 
				direction.x = x;
				direction.y = y;
				direction.z = z;
			 ...
			 * @param normalize If true, the input vector needs to be normalized
			 */
			void setDirection( const Vector3& v, bool normalize = true )
			{ 
				direction = v;
				if( normalize )
					direction.normalise();
...
// Distance methods				
			 ...
			 */
			Real squaredDistance( const Line& line ) const;

			/** Computes the distance from this ray to a line
			 */
			Real distance( const Line& line ) const;
