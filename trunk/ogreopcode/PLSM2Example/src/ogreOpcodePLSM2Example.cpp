#include "ogreOpcodePLSM2Example.h"

//-------------------------------------------------------------------------------------
OgreOpcodePLSM2Example::OgreOpcodePLSM2Example(void)
: OgreOpcodeExample(),
collideContext(0),
mRobotCollObj(0),
...
//-------------------------------------------------------------------------------------
void OgreOpcodePLSM2Example::createScene(void)
{
	// Set ambient light
...
//-------------------------------------------------------------------------------------
bool OgreOpcodePLSM2Example::processUnbufferedKeyInput(const FrameEvent& evt)
{
...
//-------------------------------------------------------------------------------------
bool OgreOpcodePLSM2Example::frameStarted(const FrameEvent& evt)
{
	if (mPlayAnimation)
	{
