#include "ogreOpcodeBSPExample.h"

//-------------------------------------------------------------------------------------
OgreOpcodeBSPExample::OgreOpcodeBSPExample(void)
: OgreOpcodeExample(),
collideContext(0),
mRobotCollObj(0),
...
//-------------------------------------------------------------------------------------
void OgreOpcodeBSPExample::createScene(void)
{
	// Set ambient light
...
//-------------------------------------------------------------------------------------
bool OgreOpcodeBSPExample::processUnbufferedKeyInput(const FrameEvent& evt)
{
...
//-------------------------------------------------------------------------------------
bool OgreOpcodeBSPExample::frameStarted(const FrameEvent& evt)
{
	if (mPlayAnimation)
	{
