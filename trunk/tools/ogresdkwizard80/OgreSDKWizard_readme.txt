...
1) Place the OgreSDKWizard80 folder somewhere sensible.
...
The install script changes the ABSOLUTE_PATH in OgreSDKAppWizard80.vsz to point to whereever you put the wizard files.
...
Look at script.js in OgreSDKAppWizard80\Files\Scripts\1033 and the template files in OgreSDKAppWizard80\Files\Templates.
...
2) Copy the three "OgreSDKAppWizard80.*" files over to your [Visual Studio]/VC/vcprojects folder.
