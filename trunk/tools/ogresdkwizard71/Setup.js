...
// Setup program for the Ogre SDK Application Wizard
...
function main()
{
	...
	try
	{
		strSrc = strSourceFolder + "\\OgreSDKWizard71.ico";
		FileSys.CopyFile(strSrc, strDest);
		strSrc = strSourceFolder + "\\OgreSDKWizard71.vsdir";
		FileSys.CopyFile(strSrc, strDest);
	}
	catch(e)
	{
	...
	// Read and write OgreSDKWizard71.vsz, replace path when found
	try
	{
		strSrc = strSourceFolder + "\\OgreSDKWizard71.vsz";
		strDest = strDestFolder + "\\OgreSDKWizard71.vsz";
	...
	catch(e)
	{
		...
		if(e.description.length != 0)
			strError = e.description;
		WScript.Echo("ERROR: Cannot read and write OgreSDKWizard71.vsz (" + strError + ")");
		return;
	}
