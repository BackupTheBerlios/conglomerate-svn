...
1) Place the ogrewizard80 folder somewhere sensible.

2) Run VC8_Express_Setup.js or VC8_Setup.js (depending on your version of VC) to install this Ogre SDK Application Wizard!
(Double-click on it)

3) Remember: Do Not delete this folder - your Ogre Wizard needs the files.
The install script changes the ABSOLUTE_PATH in OgreAppWizard80.vsz to point to whereever you put the wizard files.
...
Make sure that you've followed every single step of the instructions here: http://www.ogre3d.org/wiki/index.php/Installing_An_SDK#MS_Visual_C.2B.2B

It is especially important to go through all FIVE steps: http://msdn.microsoft.com/vstudio/express/visualc/usingpsdk/default.aspx

Make sure that you are able to select a regular win32 project, compile and run it.



If the wizard errors out about not finding winres.h, you probably need to add this directory to Tools - Options - Projects - Directories - Include:
...
Look at script.js in ogrewizard80\Files\Scripts\1033 and the template files in ogrewizard80\Files\Templates.
...
Visual Studio:
1) Edit the OgreAppWizard80.vsz -> change "ABSOLUTE_PATH" to where you have unzipped this Ogre-wizard.
2) Copy the three "OgreAppWizard80.*" files over to your [Visual Studio]/VC/vcprojects folder.

Visual Studio Express:
1) Edit the OgreAppWizard80.vsz -> change "ABSOLUTE_PATH" to where you have unzipped this Ogre-wizard.
2) Copy the three "OgreAppWizard80.*" files over to your [Visual Studio]/VC/Express/VCProjects folder.
